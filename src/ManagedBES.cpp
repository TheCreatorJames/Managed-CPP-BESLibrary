...
ManagedBES::ManagedBasylKeyGenerator::ManagedBasylKeyGenerator(String ^ pass) :
    gen(nullptr)
{
...
ManagedBES::ManagedBasylKeyGenerator::ManagedBasylKeyGenerator
    (
        String ^
        ...
        gen(nullptr)
{
    ...
    gen = new BasylKeyGenerator
        (
            pass2, initial, rounds, leftoff, expansion, additional, _hash, _key1,
                _key2, encrypted
        );
}
